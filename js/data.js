...
window.CCF_DATA = {
  ...
  locais: [
    {
      ...
      reunioes: [
        { quando: "DOMINGO · 18H", titulo: "Reunião do Partir do Pão" },
      ],
      galeria: ["images/img5.jpg", "images/casa 1 1.jpg", "images/img4.jpg"],
    ...
    },
    {
      ...
      galeria: [
        "images/reuniaodejovens.jpeg",
        "images/ministerial.jpeg",
        "images/casa 3 1.jpeg",
      ],
  ...
  reunioes: [
    {
      tag: "DOMINGO · 18H",
      titulo: "Reunião da Mesa do Senhor",
      texto: "A ceia e a Palavra reunindo toda a família da igreja.",
      img: "images/reuniaopartirdopao.jpg",
    },
    {
      tag: "JOVENS & ADOLESCENTES",
      titulo: "Reunião de Jovens",
      texto: "Uma geração buscando a Deus com alegria e propósito.",
      img: "images/reuniaodejovens.jpeg",
    },
    {
      tag: "DURANTE A SEMANA",
      titulo: "Reunião da Palavra",
      texto: "Ensino bíblico para edificação e crescimento espiritual.",
      img: "images/ministerial.jpeg",
    },
    {
      tag: "DURANTE A SEMANA",
      titulo: "Reunião de Oração",
      texto: "Buscando juntos a presença e a direção de Deus.",
      img: "images/reuniaodeoracao.jpeg",
    },
  ],
};
