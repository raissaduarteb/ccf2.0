    ...
    >
      <div className="site-header__bar">
        ...
        >
          ...
          <span className="brand__name">
            <b>CCF</b>
            <small>COMUNIDADE CRISTÃ EM FORTALEZA</small>
          </span>
        </a>
        ...
        <nav className="nav" aria-label="Principal">
          ...
          >
            <button
              ...
              aria-haspopup="true"
              onClick={() =>
                setOpenMenu(openMenu === "igreja" ? null : "igreja")
              }
            >
          ...
          >
            <button
              ...
              aria-haspopup="true"
              onClick={() =>
                setOpenMenu(openMenu === "conteudo" ? null : "conteudo")
              }
            >
          ...
          <a
            className="nav__link nav__cta btn btn--primary btn--sm"
            href="#/fale-conosco"
      ...
      >
        ...
        <div className="mobile-menu__group">
          ...
          <button className="mobile-menu__link" onClick={go("/", "quemsomos")}>
            Quem somos
          </button>
          <button className="mobile-menu__link" onClick={go("/", "nossavisao")}>
            Nossa visão
          </button>
          <button className="mobile-menu__link" onClick={go("/onde-estamos")}>
            Onde estamos
          </button>
          <button className="mobile-menu__link" onClick={go("/contribuicao")}>
            Contribuição
          </button>
          <button className="mobile-menu__link" onClick={go("/roteiros-pgm")}>
            Roteiros PGM
          </button>
          <a
