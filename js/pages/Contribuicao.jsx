...
function CopyButton({ value }) {
  ...
  return (
    <button className="pix-copy" type="button" onClick={copy}>
      {done ? "✓ Copiado" : "Copiar"}
    </button>
  );
}
  ...
  return (
    <main>
      <section
        ...
        style={{ height: "42vh", minHeight: "320px" }}
        data-screen-label="Banner"
      >
        <img
          className="page-banner__img"
          style={{ objectPosition: "center 40%" }}
          src="images/espiritualidade-e-religiao-as-maos-postas-em-oracao-sobre-uma-biblia-sagrada-na-igreja-conceito-de-fe.jpg"
        ...
        <div className="container page-banner__inner">
          ...
          <h1>Contribuição</h1>
          <p>
            Sua oferta sustenta a obra da igreja e o avanço do evangelho. Cada
            gesto importa — e é com alegria.
          </p>
        </div>
      </section>
        ...
        <div className="give-grid reveal">
          <article className="give-card">
            ...
            <p className="give-card__desc">
              Manutenção e funcionamento da igreja local.
            </p>
            <span className="give-card__label">CHAVE PIX (CNPJ)</span>
            <div className="pix-row">
              <code>53.939.100/0001-44</code>
              <CopyButton value="53.939.100/0001-44" />
            </div>
            <div className="bank-row">
              <span className="bank-row__logo" style={{ fontSize: "13px" }}>
                ITAÚ
              </span>
              <div>
                <small>Banco Itaú</small>
                <b>Comunidade Cristã Ig. em Fortaleza</b>
              </div>
            </div>
          </article>
          ...
          <article className="give-card">
            ...
            <div className="pix-row">
              <code>missoes@ccf.org.br</code>
              <CopyButton value="missoes@ccf.org.br" />
            </div>
            <div className="bank-row">
              <span className="bank-row__logo" style={{ fontSize: "11px" }}>
                BRAD.
              </span>
              <div>
